        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Annotation = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product_Authors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Product_Authors_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Product_Authors_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_Authors_AuthorId",
                table: "Product_Authors",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_Product_Authors_ProductId",
                table: "Product_Authors",
                column: "ProductId");
